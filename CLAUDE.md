...
## 現在のステータス / 未完了（2026-07-18時点）

- エディトリアル・リデザイン全ページ本番反映済み（トップ・下層6ページ・/robotics）
- 海洋産業ニュース `/news` を追加（ローカル確認済み・本番未デプロイ）。Googleニュース検索RSSからカテゴリー別（洋上風力・海底ケーブル・水中ロボティクス・漁業水産・港湾海運・海洋資源その他）に見出しを自動収集。詳細は DESIGN-GUIDE.md §11.1。トップCONTENTSは6→7セルに変更
- 未完了・外部待ち:
